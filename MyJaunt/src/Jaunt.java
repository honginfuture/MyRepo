...
public class Jaunt {
	public static void main(String[] args) {
		System.setProperty("webdriver.chrome.driver", "/Users/Hong/eclipse/chromedriver");
		...
		doc.body().childNodes().forEach(System.out::println);//https://www.twilio.com/blog/working-with-html-on-the-web-java-jsoup
		// Get content by Class
//		Elements names = doc.getElementsByClass("name fn");
